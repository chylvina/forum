...
import com.donnfelker.android.bootstrap.core.ForumService;
...
/**
 * Unit tests of {@link com.donnfelker.android.bootstrap.core.ForumService}
 */
...
public class ForumServiceTest {
    ...
    public void before() throws IOException {
        service = new ForumService(new UserAgentProvider()) {
            protected HttpRequest execute(HttpRequest request) throws IOException {
                return ForumServiceTest.this.request;
            }
        };
